 ...
 * Based on mediaWiki.Uri.js, also by Neil Kandalgaonkar
 *
 * @author Neil Kandalgaonkar <neilk@neilk.net>
 *
...
(function($) {
  ...
  function cat(pre, val, post, raw) {
    ...
    return pre + (raw ? val : Uri.encode(val)) + post;
  }
  ...
  if (document && document.location && document.location.href) {
    Uri = UriRelative(document.location.href);
  }
